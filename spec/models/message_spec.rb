...
# Unit tests for PluralKitAPI::Message
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PluralKitAPI::Message do
  let(:instance) { PluralKitAPI::Message.new }

  describe 'test an instance of Message' do
    it 'should create an instance of Message' do
      expect(instance).to be_instance_of(PluralKitAPI::Message)
    end
  end
