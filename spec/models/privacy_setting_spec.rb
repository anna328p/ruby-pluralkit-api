...
# Unit tests for PluralKitAPI::PrivacySetting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PluralKitAPI::PrivacySetting do
  let(:instance) { PluralKitAPI::PrivacySetting.new }

  describe 'test an instance of PrivacySetting' do
    it 'should create an instance of PrivacySetting' do
      expect(instance).to be_instance_of(PluralKitAPI::PrivacySetting)
    end
  end
end
