...
# Unit tests for PluralKitAPI::FullSwitch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PluralKitAPI::FullSwitch do
  let(:instance) { PluralKitAPI::FullSwitch.new }

  describe 'test an instance of FullSwitch' do
    it 'should create an instance of FullSwitch' do
      expect(instance).to be_instance_of(PluralKitAPI::FullSwitch)
    end
  end
